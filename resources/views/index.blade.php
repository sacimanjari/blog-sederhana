    ...
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="{{route('portofolio.index')}}">Portfolio</a></li>
          <li><a href="index.html#pricing">Pricing</a></li>
          <li><a href="{{route('team.index')}}">Team</a></li>
          <li><a href="{{route('blog-details.index')}}">Blog</a></li>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 " data-aos="fade-up" data-aos-delay="100">
            <div class="service-item d-flex">
              ...
              <div>
                <h4 class="title"><a href="services-details.html" class="stretched-link">Company</a></h4>
          ...
          <div class="col-lg-6 " data-aos="fade-up" data-aos-delay="200">
            <div class="service-item d-flex">
              ...
              <div>
                <h4 class="title"><a href="services-details.html" class="stretched-link">Accessibility</a></h4>
                <p class="description">Easy to use</p>
              </div>
            </div>
          ...
          <div class="col-lg-6 " data-aos="fade-up" data-aos-delay="300">
            <div class="service-item d-flex">
              ...
              <div>
                <h4 class="title"><a href="services-details.html" class="stretched-link">Nice Growth</a></h4>
                <p class="description">Minimizing compant loss</p>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-6 " data-aos="fade-up" data-aos-delay="400">
            <div class="service-item d-flex">
              ...
              <div>
                <h4 class="title"><a href="services-details.html" class="stretched-link">Visionary</a></h4>
                <p class="description">Updated technology and innovation</p>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-6 " data-aos="fade-up" data-aos-delay="500">
            <div class="service-item d-flex">
              ...
              <div>
                <h4 class="title"><a href="services-details.html" class="stretched-link">Custom Ability</a></h4>
                <p class="description">Feel free to customize based on your needs</p>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-6 " data-aos="fade-up" data-aos-delay="600">
            <div class="service-item d-flex">
              ...
              <div>
                <h4 class="title"><a href="services-details.html" class="stretched-link">Time Efficiency</a></h4>
                <p class="description">Export
                  Finisshed our clients project on time
                </p>
              </div>
            </div>
          </div><!-- End Service Item -->
